    ...
    def __init__(self,
        ...
        for _ in range(graph_gnn_layers):
            if graph_GNN==TransformerConv:
                gnn=HeteroConv({
                    ('node', 'base_child', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//8,heads=8, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=True),
                    ('node', 'base_father', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//8,heads=8, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=False),
                    ('node', 'sibling_next', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//8,heads=8, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=False),
                    ('node', 'sibling_prev', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//8,heads=8, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=False),
                    ('node', 'dfg_next', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//8,heads=8, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=False),
                    ('node', 'dfg_prev', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//8,heads=8, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=False),
                    ('node', 'code_next', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//8,heads=8, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=False),
                    ('node', 'code_prev', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//8,heads=8, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=False),
                },aggr='sum')
