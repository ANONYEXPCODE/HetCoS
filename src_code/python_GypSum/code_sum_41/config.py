...
os.environ["CUDA_VISIBLE_DEVICES"] ="1,0,2,3" #"5,6,7,8,9","0,1,2,3,4"
import os
...
params = dict(model_dir=model_dir,
              ...
              pred_batch_size=math.ceil(train_batch_size * 1.3),  #################### 2
