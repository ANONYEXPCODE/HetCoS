...
class Datasetx(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # data['node'].code_pos = torch.tensor(self.code_graphs[index]['node_in_code_poses'])
...
class CodeGraphEnc(nn.Module):
    def __init__(self,
        ...
        for _ in range(graph_gnn_layers):
            ...
            #     gnn=HeteroConv({
            #         ('node', 'base_child', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//code_att_heads,heads=code_att_heads, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=True),
            #         ('node', 'base_father', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//code_att_heads,heads=code_att_heads, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=False),
            #         ('node', 'sibling_next', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//code_att_heads,heads=code_att_heads, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=False),
            #         ('node', 'sibling_prev', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//code_att_heads,heads=code_att_heads, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=False),
            #         ('node', 'dfg_next', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//code_att_heads,heads=code_att_heads, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=False),
            #         ('node', 'dfg_prev', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//code_att_heads,heads=code_att_heads, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=False),
            #         ('node', 'code_next', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//code_att_heads,heads=code_att_heads, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=False),
            #         ('node', 'code_prev', 'node'):TransformerConv((emb_dims,emb_dims), out_channels=emb_dims//code_att_heads,heads=code_att_heads, aggr=graph_gnn_aggr,dropout=drop_rate,root_weight=False),
            #     },aggr='sum')
